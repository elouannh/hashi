...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/27 20:08:20 by ehosta            #+#    #+#             */
/*   Updated: 2024/07/28 14:22:19 by ehosta           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
export interface JSONHashiConfigStructure {
	 ...
	 */
	// @ts-expect-error This error is generated by the implicit "copy" of the value.
